...
$(window).scroll(function () {
    ...
    $(window).width() > 1025
      ? ($("li.menu-item").hover(
        ...
        $(".box-title").hover(function () {
          $(".box-text").html(""),
            $(".box-description").html(""),
            $(".box-text").html("<strong>" + $(this).text() + "</strong>"),
            $(".box-description").html($(this).next().text()),
            $(".box-image").css(
              "background-image",
              "url(" + $(this).data("image") + ")"
            );
      ...
      : $(".has-dropdown").click(function () {
          var e = $("body");
          $(this).find("a").toggleClass("active"), e.toggleClass("nav_show");
        }),
      ...
      $(".navs_toggle").click(function () {
        $("html").hasClass("cart-is-active") &&
          ($(".cart").removeClass("cart-is-active"),
          $("html").removeClass("cart-is-active")),
          $("html").hasClass("toggled-user") &&
            ($(".dropdown__trigger-js")
              .parent(".dropdown")
        ...
        var e = $("body");
        return (
          e.hasClass("toggled_left")
            ? e.removeClass("toggled_left")
            : e.addClass("toggled_left"),
          !1
        );
      }),
      $("body").click(function () {
        $("body").hasClass("toggled_left") &&
  ...
  $(function () {
    var e = $('a[href*="#"].has-dropmenu');
    e.click(function (s) {
      s.preventDefault();
      var t = "";
      if (
        (console.log($(this).attr("href").slice(1)), $(window).width() < 1199)
      ) {
        e.each(function () {
          $("#" + $(this).attr("href").slice(1)).hasClass("is-active") &&
            (t = $(this).attr("href").slice(1)),
            $("#" + $(this).attr("href").slice(1)).removeClass("is-active");
        });
        var i = $("#" + $(this).attr("href").slice(1));
        $(this).attr("href").slice(1) != t && i.addClass("is-active");
      }
      $(window).width() > 1199 &&
        (e.each(function () {
          $("#" + $(this).attr("href").slice(1)).removeClass("is-active");
        }),
        (i = $("#" + $(this).attr("href").slice(1))).addClass("is-active"));
    }),
      $(document).on(
        "click",
        ".header-navigation ul li a.has-dropmenu",
        function () {
          $(".navigation-wrap").addClass("is-opened"),
            $("html").addClass("hidden-overflow");
        }
      ),
      $(".close--header").click(function () {
        $(".navigation-wrap").removeClass("is-opened"),
    ...
    $(".js-acc-triger").on("click", function (e) {
      e.preventDefault(),
        $(this).hasClass("active")
          ? ($(this).removeClass("active"), $(this).next().stop().slideUp(300))
          : ($(".js-acc-triger.active").next().stop().slideUp(300),
            $(".js-acc-triger").removeClass("active"),
            $(this).addClass("active"),
  ...
  $(document).ready(function () {
    $(".header-topbar-close").click(function () {
      $("body").addClass("hidden-topbar"),
        $(".header-topbar").css({
          height: "0",
          padding: "0",
          opacity: "0",
